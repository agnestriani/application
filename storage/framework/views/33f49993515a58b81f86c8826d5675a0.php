    ...
    <section>
        ...
        <div class="flex justify-end mt-2 items-center">
            ...
            <div id="circleButton" class="bg-[#3687FF] hover:bg-opacity-80 w-14 h-14 rounded-full ml-6 flex items-center justify-center cursor-pointer transition duration-300 active:ring-2">
                <a href="/tambahmahasiswa" title="Tambah" class="flex items-center justify-center w-full h-full">
            ...
            <table class="border border-slate-700 w-full m-2">
                    <thead>
                        <tr>
                            ...
                            <td class="border border-slate-700 p-2 text-center">Jenis Kelamin</td>
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-700 p-2 text-center">
                                <div class="flex items-center justify-center space-x-3">
                                    <a href="updatemahasiswa.php" title="Ubah">
    ...
    <section>
        ...
        <div class="flex justify-items-center mt-20">
            <div class="flex justify-start mt-2 ml-2">
                <p class="text-black text-xl font-balsamiq font-bold">Showing you 5 out of 23</p>
            </div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\application\resources\views/mahasiswa.blade.php ENDPATH**/ ?>