<nav class="bg-gradient-custom flex flex-col">
    ...
    <div class="flex-1">
        <div class="flex items-center space-x-4 ml-20 -mt-14">
            ...
            <x-nav-link href="/dashboardkaprodi" :active="request()->is('dashboardkaprodi')">Dashboard</x-nav-link>
        </div>
        ...
        <div class="flex items-center space-x-4 ml-20 mt-10">
            ...
            <x-nav-link href="/aspek" :active="request()->is('aspek')">Aspek</x-nav-link>
        </div>
        ...
        <div class="flex items-center space-x-4 ml-20 mt-10">
            ...
            <x-nav-link href="/nilaiprofile" :active="request()->is('nilaiprofile')">Nilai Profile</x-nav-link>
        </div>
